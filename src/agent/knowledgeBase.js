...
function extractKeywords(text) {
    ...
    const domainTerms = [
        ...
        'basecost', 'giá', 'pricing', 'chi phí',
        'printify', 'printful', 'weshop', 'supership', 'boxme',
        'tiktok', 'etsy', 'amazon', 'shopify', 'ebay',
        'us', 'mỹ', 'uk', 'úc', 'uae', 'saudi', 'chile', 'colombia',
        'buyer', 'seller', 'provider', 'đối thủ', 'cạnh tranh',
        'tìm', 'cần', 'hỏi', 'so sánh', 'recommend', 'review',
        'tracking', 'delay', 'stuck', 'chậm', 'nhanh',
        'e-packet', 'air cargo', 'fba', 'fbm',
        'xưởng', 'in ấn', 'đóng gói', 'pick up',
        'kho pa', 'kho nc', 'pennsylvania', 'north carolina',
    ];
